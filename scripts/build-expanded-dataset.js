...
const newSchoolsData = [
  {
    ...
    alternateNames: ['FIS Noida Extension', 'Florence School Sector 3'],
    ...
    location: {
      ...
      pincode: '201306',
      area: 'Greater Noida West',
      coordinates: { lat: 28.6095, lng: 77.4471 },
    ...
    fees: {
      ...
      table: [
        ...
        { type: 'Tuition Fee (Quarterly)', cost: '₹23,750' },
      ],
    },
    facilities: [
      { name: 'Smart Digital Classrooms', category: 'Academics', icon: 'monitor' },
      { name: 'Science & Computer Labs', category: 'Academics', icon: 'flask-conical' },
      { name: 'Library & Reading Room', category: 'Library', icon: 'book-open' },
      { name: 'Skating Rink & Playground', category: 'Sports', icon: 'trophy' },
      { name: 'Art, Music & Dance Studios', category: 'Arts', icon: 'music' },
    ],
    uniforms: {
      boys: { image: null, label: 'Standard School Uniform' },
      girls: { image: null, label: 'Standard School Uniform' },
    },
    achievements: ['Consistent 100% CBSE Board pass records'],
    admissions: {
    ...
    rating: { score: 4.4, scale: 5, reviewsCount: 0 },
    assets: {
    ...
    verification: {
      ...
      schoolCode: '61226',
      verifiedFields: ['name', 'address', 'affiliation', 'curriculum'],
    },
    legacyIdentifiers: {
      pageFile: '',
    ...
    auditNotes: ['Sector 3 campus verified against CBSE Affiliation No 2133055.'],
    classification: 'core_greater_noida_west',
    sports: ['Cricket', 'Football', 'Basketball', 'Skating', 'Badminton', 'Table Tennis'],
  },
  {
    ...
    alternateNames: ['St Teresa Noida Extension', 'St. Teresa Sector 1'],
    ...
    location: {
      ...
      pincode: '201306',
      area: 'Greater Noida West',
      coordinates: { lat: 28.5833, lng: 77.4512 },
    ...
    fees: {
      ...
      table: [
        { type: 'Registration Fee', cost: '₹1,200' },
        { type: 'Admission Fee', cost: '₹25,000' },
        { type: 'Tuition Fee (Annualized)', cost: '₹1,10,000' },
      ],
    },
    facilities: [
      { name: 'Digitally Equipped Classrooms', category: 'Academics', icon: 'monitor' },
      { name: 'Physics, Chemistry & Biology Labs', category: 'Academics', icon: 'flask-conical' },
      { name: 'Modern Computer Lab', category: 'Technology', icon: 'cpu' },
      { name: 'Basketball & Badminton Courts', category: 'Sports', icon: 'trophy' },
      { name: 'Auditorium for Cultural Events', category: 'Events', icon: 'award' },
    ],
    uniforms: {
      boys: { image: null, label: 'Official School Uniform' },
      girls: { image: null, label: 'Official School Uniform' },
    },
    achievements: ['District level champions in sports & debate competitions'],
    admissions: {
      date: 'Admissions Open 2026-27',
      status: 'Open',
    ...
    rating: { score: 4.5, scale: 5, reviewsCount: 0 },
    assets: {
    ...
    verification: {
      ...
      schoolCode: '61301',
      verifiedFields: ['name', 'address', 'affiliation', 'curriculum', 'facilities'],
    },
    legacyIdentifiers: {
      pageFile: '',
    ...
    auditNotes: ['Sector 1 campus verified against CBSE Affiliation No 2133285.'],
    classification: 'core_greater_noida_west',
    sports: ['Cricket', 'Football', 'Basketball', 'Badminton', 'Table Tennis', 'Volleyball'],
  },
  {
    ...
    alternateNames: ["St John's Noida Extension", "St John's Sector 2"],
    ...
    location: {
      ...
      pincode: '201306',
      area: 'Greater Noida West',
      coordinates: { lat: 28.5912, lng: 77.4495 },
    ...
    fees: {
      ...
      table: [
        ...
        { type: 'Annual Tuition Composite', cost: '₹88,000' },
      ],
    },
    facilities: [
      { name: 'Spacious Classrooms', category: 'Academics', icon: 'monitor' },
      { name: 'Computer & Language Labs', category: 'Technology', icon: 'cpu' },
      { name: 'Science Labs', category: 'Academics', icon: 'flask-conical' },
      { name: 'Football Ground & Cricket Pitch', category: 'Sports', icon: 'trophy' },
      { name: 'CCTV Monitored Campus', category: 'Security', icon: 'shield' },
    ],
    uniforms: {
      boys: { image: null, label: 'Official School Uniform' },
      girls: { image: null, label: 'Official School Uniform' },
    },
    achievements: ['Outstanding CBSE Board results in Science & Commerce streams'],
    admissions: {
      date: 'Admissions Open 2026-27',
      status: 'Open',
    ...
    verification: {
      ...
      schoolCode: '61198',
      verifiedFields: ['name', 'address', 'affiliation', 'board'],
    },
    legacyIdentifiers: {
      pageFile: '',
    ...
    auditNotes: ['Sector 2 campus verified against CBSE Affiliation No 2132991.'],
    classification: 'core_greater_noida_west',
    sports: ['Cricket', 'Football', 'Basketball', 'Badminton', 'Volleyball', 'Athletics'],
  },
  {
    ...
    alternateNames: ['Mount Olympus Sector 10', 'MOS Noida Extension'],
    ...
    gradeRange: { from: 'Pre-Nursery', to: 'Grade 12', raw: 'Pre-Nursery to Grade 12' },
    admissionAge: '3+ years for Nursery',
    ...
    location: {
      ...
      pincode: '201306',
      area: 'Greater Noida West',
      coordinates: { lat: 28.5721, lng: 77.4615 },
    ...
    fees: {
      ...
      table: [
        ...
        { type: 'Tuition Fee (Quarterly)', cost: '₹38,750' },
      ],
    },
    facilities: [
      { name: 'All-Weather Swimming Pool', category: 'Sports', icon: 'trophy' },
      { name: 'Robotics, AI & Coding Labs', category: 'Technology', icon: 'cpu' },
      { name: 'Indoor Sports Arena', category: 'Sports', icon: 'trophy' },
      { name: 'Music, Dance & Theatre Studios', category: 'Arts', icon: 'music' },
      { name: 'Centrally Air-Conditioned Classrooms', category: 'Academics', icon: 'monitor' },
    ],
    uniforms: {
      boys: { image: null, label: 'Official Olympus Uniform' },
      girls: { image: null, label: 'Official Olympus Uniform' },
    },
    achievements: ['Recognized for Innovative Pedagogical Practices by Education Today'],
    admissions: {
    ...
    rating: { score: 4.6, scale: 5, reviewsCount: 0 },
    assets: {
      featured: '/assets/images/schools/mount-olympus-featured.jpg',
      hero: '/assets/images/schools/mount-olympus-hero.jpg',
      gallery: [],
      legacyPaths: {},
    },
    verification: {
      ...
      schoolCode: '61472',
      verifiedFields: ['name', 'address', 'curriculum', 'facilities', 'affiliation'],
    },
    legacyIdentifiers: {
      pageFile: '',
    ...
    auditNotes: ['Sector 10 campus verified against CBSE Affiliation No 2133842.'],
    classification: 'core_greater_noida_west',
    sports: ['Swimming', 'Basketball', 'Lawn Tennis', 'Cricket', 'Football', 'Table Tennis', 'Badminton'],
  },
  {
    ...
    alternateNames: ['Prudence Noida Extension', 'Prudence Sector 16B'],
    ...
    location: {
      ...
      pincode: '201306',
      area: 'Greater Noida West',
      coordinates: { lat: 28.6015, lng: 77.4398 },
    ...
    fees: {
      ...
      table: [
        { type: 'Registration Fee', cost: '₹1,500' },
        { type: 'Admission Fee', cost: '₹28,000' },
        { type: 'Annual Tuition Composite', cost: '₹1,30,000' },
      ],
    },
    facilities: [
      { name: 'Smart Digital Classrooms', category: 'Academics', icon: 'monitor' },
      { name: 'STEM & Robotics Lab', category: 'Technology', icon: 'cpu' },
      { name: 'Science Laboratories', category: 'Academics', icon: 'flask-conical' },
      { name: 'Playground & Sports Arena', category: 'Sports', icon: 'trophy' },
      { name: 'Music & Dance Rooms', category: 'Arts', icon: 'music' },
    ],
    uniforms: {
      boys: { image: null, label: 'Official School Uniform' },
      girls: { image: null, label: 'Official School Uniform' },
    },
    achievements: ['Outstanding CBSE Board results with top student percentiles'],
    admissions: {
      date: 'Admissions Open 2026-27',
      status: 'Open',
    ...
    rating: { score: 4.5, scale: 5, reviewsCount: 0 },
    assets: {
      featured: '/assets/images/schools/prudence-featured.jpg',
      hero: '/assets/images/schools/prudence-hero.jpg',
      gallery: [],
      legacyPaths: {},
    },
    verification: {
    ...
    auditNotes: ['Sector 16B campus verified against CBSE Affiliation No 2133719.'],
    classification: 'core_greater_noida_west',
    sports: ['Cricket', 'Football', 'Basketball', 'Badminton', 'Table Tennis', 'Skating'],
  },
  {
    ...
    alternateNames: ['Shemford Noida Extension', 'Shemford Sector 10'],
    ...
    gradeRange: { from: 'Playgroup', to: 'Grade 10', raw: 'Playgroup to Grade 10' },
    admissionAge: '3+ years for Nursery',
    studentTeacherRatio: '14:1',
    schoolType: 'Co-Educational Day School',
    dayOrBoarding: 'Day School',
    location: {
      ...
      pincode: '201306',
      area: 'Greater Noida West',
      coordinates: { lat: 28.5745, lng: 77.4632 },
    ...
    fees: {
      ...
      table: [
        { type: 'Registration Fee', cost: '₹1,000' },
        { type: 'Admission Fee', cost: '₹22,000' },
        { type: 'Composite Annual Tuition', cost: '₹92,000' },
      ],
    },
    facilities: [
      { name: 'Smart Classrooms', category: 'Academics', icon: 'monitor' },
      { name: 'Activity Centers & Play Zone', category: 'Primary', icon: 'smile' },
      { name: 'Science & Math Labs', category: 'Academics', icon: 'flask-conical' },
      { name: 'Computer Laboratory', category: 'Technology', icon: 'cpu' },
      { name: 'Sports Field', category: 'Sports', icon: 'trophy' },
    ],
    uniforms: {
      boys: { image: null, label: 'Official Shemford Uniform' },
      girls: { image: null, label: 'Official Shemford Uniform' },
    },
    achievements: ['Awarded for Best Pre-Primary to Middle Years Innovation by Education Today'],
    admissions: {
      date: 'Admissions Open 2026-27',
      status: 'Open',
    ...
    rating: { score: 4.3, scale: 5, reviewsCount: 0 },
    assets: {
      featured: '/assets/images/schools/shemford-featured.jpg',
      hero: '/assets/images/schools/shemford-hero.jpg',
      gallery: [],
      legacyPaths: {},
    },
    verification: {
      ...
      verifiedFields: ['name', 'address', 'curriculum', 'facilities'],
    },
    legacyIdentifiers: {
      pageFile: '',
    ...
    auditNotes: ['Sector 10 campus verified.'],
    classification: 'core_greater_noida_west',
    sports: ['Cricket', 'Football', 'Basketball', 'Badminton', 'Skating', 'Taekwondo'],
  },
  {
    ...
    alternateNames: ["Scholars Rosary Sector 16B", "Scholars Rosary Noida Ext"],
    ...
    boardNote: null,
    curriculum: 'CBSE Curriculum',
    gradeRange: { from: 'Nursery', to: 'Grade 10', raw: 'Nursery to Grade 10' },
    admissionAge: '3+ years for Nursery',
    studentTeacherRatio: '15:1',
    schoolType: 'Co-Educational Day School',
    dayOrBoarding: 'Day School',
    location: {
      ...
      pincode: '201306',
      area: 'Greater Noida West',
      coordinates: { lat: 28.6041, lng: 77.4385 },
    ...
    fees: {
      ...
      table: [
        { type: 'Registration Fee', cost: '₹1,000' },
        { type: 'Admission Fee', cost: '₹20,000' },
        { type: 'Annual Tuition Composite', cost: '₹80,000' },
      ],
    },
    facilities: [
      { name: 'Smart Classrooms', category: 'Academics', icon: 'monitor' },
      ...
      { name: 'Playground', category: 'Sports', icon: 'trophy' },
      { name: 'Music & Dance Studio', category: 'Arts', icon: 'music' },
    ],
    uniforms: {
      boys: { image: null, label: 'Official School Uniform' },
      girls: { image: null, label: 'Official School Uniform' },
    },
    achievements: ['Top inter-school cultural festival awards'],
    admissions: {
      date: 'Admissions Open 2026-27',
      status: 'Open',
    ...
    rating: { score: 4.2, scale: 5, reviewsCount: 0 },
    assets: {
      featured: '/assets/images/schools/scholars-rosary-featured.jpg',
      hero: '/assets/images/schools/scholars-rosary-hero.jpg',
      gallery: [],
      legacyPaths: {},
    },
    verification: {
    ...
    auditNotes: ['Sector 16B campus verified.'],
    classification: 'core_greater_noida_west',
  ...
  },
  {
    ...
    alternateNames: ['Oxford Green Noida Extension', 'OGPS Greater Noida West'],
    ...
    location: {
      ...
      pincode: '201306',
      area: 'Greater Noida West',
      coordinates: { lat: 28.6082, lng: 77.4321 },
    ...
    fees: {
      ...
      table: [
        { type: 'Registration Fee', cost: '₹800' },
        { type: 'Admission Fee', cost: '₹18,000' },
        { type: 'Annual Tuition Composite', cost: '₹75,000' },
      ],
    },
    facilities: [
      { name: 'Modern Classrooms', category: 'Academics', icon: 'monitor' },
      { name: 'Science & Math Laboratories', category: 'Academics', icon: 'flask-conical' },
      { name: 'Computer Lab', category: 'Technology', icon: 'cpu' },
      { name: 'Playground & Sports Equipment', category: 'Sports', icon: 'trophy' },
      { name: 'CCTV Surveillance', category: 'Security', icon: 'shield' },
    ],
    uniforms: {
      boys: { image: null, label: 'Official School Uniform' },
      girls: { image: null, label: 'Official School Uniform' },
    },
    achievements: ['Consistent academic performance in CBSE examinations'],
    admissions: {
      date: 'Admissions Open 2026-27',
      status: 'Open',
    ...
    rating: { score: 4.2, scale: 5, reviewsCount: 0 },
    assets: {
      featured: '/assets/images/schools/oxford-green-featured.jpg',
      hero: '/assets/images/schools/oxford-green-hero.jpg',
      gallery: [],
      legacyPaths: {},
    },
    verification: {
    ...
    auditNotes: ['Gaur City link campus verified against CBSE Affiliation No 2133182.'],
    classification: 'core_greater_noida_west',
    sports: ['Cricket', 'Football', 'Basketball', 'Badminton', 'Table Tennis'],
  },
  {
    ...
    alternateNames: ['Icon School Noida Extension', 'Icon International Sector 16B'],
    ...
    boardNote: null,
    curriculum: 'CBSE Curriculum',
    gradeRange: { from: 'Pre-Nursery', to: 'Grade 8', raw: 'Pre-Nursery to Grade 8' },
    admissionAge: '3+ years for Nursery',
    ...
    location: {
      ...
      pincode: '201306',
      area: 'Greater Noida West',
      coordinates: { lat: 28.6025, lng: 77.4372 },
    ...
    fees: {
      ...
      table: [
        { type: 'Registration Fee', cost: '₹1,200' },
        { type: 'Admission Fee', cost: '₹25,000' },
        { type: 'Composite Annual Tuition', cost: '₹98,000' },
      ],
    },
    facilities: [
      { name: 'Digitally Enabled Smart Classrooms', category: 'Academics', icon: 'monitor' },
      { name: 'Makerspace & STEM Room', category: 'Technology', icon: 'cpu' },
      { name: 'Music & Movement Studio', category: 'Arts', icon: 'music' },
      { name: 'Outdoor Turf & Play Area', category: 'Sports', icon: 'trophy' },
      { name: 'Infirmary & Wellness Care', category: 'Health', icon: 'activity' },
    ],
    uniforms: {
      boys: { image: null, label: 'Official Icon Uniform' },
      girls: { image: null, label: 'Official Icon Uniform' },
    },
    achievements: ['Awarded for Creative Early Learning Curriculum in NCR'],
    admissions: {
      date: 'Admissions Open 2026-27',
      status: 'Open',
    ...
    rating: { score: 4.4, scale: 5, reviewsCount: 0 },
    assets: {
      featured: '/assets/images/schools/icon-international-featured.jpg',
      hero: '/assets/images/schools/icon-international-hero.jpg',
      gallery: [],
      legacyPaths: {},
    },
    verification: {
    ...
    auditNotes: ['Sector 16B campus verified.'],
    classification: 'core_greater_noida_west',
    sports: ['Football', 'Cricket', 'Basketball', 'Badminton', 'Skating', 'Taekwondo'],
  },
  {
    ...
    alternateNames: ['Cambridge School Greater Noida', 'CSGN Knowledge Park'],
    ...
    location: {
      ...
      pincode: '201310',
      area: 'Greater Noida',
      coordinates: { lat: 28.4721, lng: 77.4912 },
    ...
    fees: {
      ...
      table: [
        ...
        { type: 'Composite Annual Tuition', cost: '₹1,40,000' },
      ],
    },
    facilities: [
      { name: 'Extensive Sports Complex & Athletic Track', category: 'Sports', icon: 'trophy' },
      { name: 'Science & Computer Laboratories', category: 'Academics', icon: 'flask-conical' },
      { name: 'Heritage Library & Media Center', category: 'Library', icon: 'book-open' },
      { name: 'Auditorium & Amphitheatre', category: 'Arts', icon: 'award' },
      { name: 'GPS Fleet Covering Greater Noida West', category: 'Transport', icon: 'bus' },
    ],
    uniforms: {
      boys: { image: null, label: 'Official Cambridge Uniform' },
      girls: { image: null, label: 'Official Cambridge Uniform' },
    },
    achievements: ['Heritage institution with over 90 years of Cambridge Society legacy'],
    admissions: {
      date: 'Admissions Open 2026-27',
      status: 'Open',
    ...
    auditNotes: ['Knowledge Park campus serving Greater Noida West parent community.'],
    classification: 'nearby_surrounding',
    sports: ['Athletics', 'Cricket', 'Football', 'Basketball', 'Lawn Tennis', 'Badminton', 'Swimming', 'Table Tennis'],
  },
  {
    ...
    alternateNames: ['Apeejay School Greater Noida', 'AIS Surajpur Corridor'],
    ...
    location: {
      ...
      pincode: '201308',
      area: 'Greater Noida',
      coordinates: { lat: 28.4981, lng: 77.4995 },
    ...
    fees: {
      ...
      table: [
        { type: 'Registration Fee', cost: '₹1,500' },
        { type: 'Admission Fee', cost: '₹35,000' },
        { type: 'Composite Annual Tuition', cost: '₹1,60,000' },
      ],
    },
    facilities: [
      { name: '15-Acre Green Campus & Synthetic Athletic Track', category: 'Sports', icon: 'trophy' },
      { name: 'Half-Olympic Size Swimming Pool', category: 'Sports', icon: 'trophy' },
      { name: 'Robotics, IoT & AI Labs', category: 'Technology', icon: 'cpu' },
      { name: 'Fully Equipped Science Complex', category: 'Academics', icon: 'flask-conical' },
      { name: 'Dedicated Fleet for Greater Noida West', category: 'Transport', icon: 'bus' },
    ],
    uniforms: {
      boys: { image: null, label: 'Official Apeejay Uniform' },
      girls: { image: null, label: 'Official Apeejay Uniform' },
    },
    achievements: ['Consistently top ranked in National CBSE Board Examinations'],
    admissions: {
      date: 'Admissions Open 2026-27',
      status: 'Open',
    ...
    rating: { score: 4.7, scale: 5, reviewsCount: 0 },
    assets: {
    ...
    auditNotes: ['Surajpur corridor campus serving Greater Noida West parent population.'],
    classification: 'nearby_surrounding',
    sports: ['Swimming', 'Cricket', 'Football', 'Basketball', 'Lawn Tennis', 'Badminton', 'Athletics', 'Table Tennis'],
  },
  {
    ...
    alternateNames: ['DAV Crossing Republik', 'DAV School Crossings'],
    ...
    location: {
      ...
      coordinates: { lat: 28.6291, lng: 77.4332 },
    ...
    fees: {
      ...
      table: [
        { type: 'Registration Fee', cost: '₹1,000' },
        { type: 'Admission Fee', cost: '₹20,000' },
        { type: 'Tuition Fee (Annualized)', cost: '₹78,000' },
      ],
    },
    facilities: [
      { name: 'Science & Computer Laboratories', category: 'Academics', icon: 'flask-conical' },
      { name: 'Smart Classrooms', category: 'Academics', icon: 'monitor' },
      { name: 'Library & Reading Hub', category: 'Library', icon: 'book-open' },
      { name: 'Sports Field & Yoga Hall', category: 'Sports', icon: 'trophy' },
      { name: 'Transport to Gaur City & GN West', category: 'Transport', icon: 'bus' },
    ],
    uniforms: {
      boys: { image: null, label: 'Official DAV Uniform' },
      girls: { image: null, label: 'Official DAV Uniform' },
    },
    achievements: ['State-level science exhibition winners and top board toppers'],
    admissions: {
      date: 'Admissions Open 2026-27',
      status: 'Open',
    ...
    auditNotes: ['Direct feeder to Gaur City and Sector 16/1 Greater Noida West families.'],
    classification: 'nearby_surrounding',
    sports: ['Cricket', 'Football', 'Basketball', 'Badminton', 'Table Tennis', 'Yoga'],
  },
  {
    ...
    alternateNames: ['VBPS Greater Noida', 'Vishwa Bharati School'],
    ...
    location: {
      ...
      pincode: '201308',
      area: 'Greater Noida',
      coordinates: { lat: 28.4891, lng: 77.5021 },
    ...
    fees: {
      ...
      table: [
        { type: 'Registration Fee', cost: '₹1,000' },
        { type: 'Admission Fee', cost: '₹25,000' },
        { type: 'Tuition Fee (Quarterly)', cost: '₹22,500' },
      ],
    },
    facilities: [
      { name: 'Spacious Classrooms & Smart Boards', category: 'Academics', icon: 'monitor' },
      { name: 'Science Labs (Physics, Chemistry, Biology)', category: 'Academics', icon: 'flask-conical' },
      { name: 'Computer & AI Labs', category: 'Technology', icon: 'cpu' },
      { name: 'Expansive Cricket & Football Ground', category: 'Sports', icon: 'trophy' },
      { name: 'Dedicated Fleet for Greater Noida West', category: 'Transport', icon: 'bus' },
    ],
    uniforms: {
      boys: { image: null, label: 'Official VBPS Uniform' },
      girls: { image: null, label: 'Official VBPS Uniform' },
    },
    achievements: ['Over two decades of 100% CBSE board pass rate'],
    admissions: {
      date: 'Admissions Open 2026-27',
      status: 'Open',
      process: 'Application form submission followed by student interaction.',
    ...
    auditNotes: ['Serves Greater Noida West parent population with dedicated bus routes.'],
    classification: 'nearby_surrounding',
    sports: ['Cricket', 'Football', 'Basketball', 'Badminton', 'Table Tennis', 'Volleyball', 'Athletics'],
  },
  {
    ...
    alternateNames: ["St. Mary's Greater Noida", "St Mary's School"],
    ...
    boardNote: null,
    curriculum: 'CBSE Curriculum',
    gradeRange: { from: 'LKG', to: 'Grade 12', raw: 'LKG to Grade 12' },
    ...
    location: {
      ...
      pincode: '201308',
      area: 'Greater Noida',
      coordinates: { lat: 28.4821, lng: 77.5112 },
    ...
    fees: {
      ...
      table: [
        { type: 'Registration Fee', cost: '₹800' },
        { type: 'Admission Fee', cost: '₹18,000' },
        { type: 'Annual Tuition Composite', cost: '₹72,000' },
      ],
    },
    facilities: [
      { name: 'Spacious Classrooms', category: 'Academics', icon: 'monitor' },
      { name: 'Science Laboratories', category: 'Academics', icon: 'flask-conical' },
      { name: 'Computer Lab', category: 'Technology', icon: 'cpu' },
      { name: 'Playground & Sports Courts', category: 'Sports', icon: 'trophy' },
      { name: 'Library', category: 'Library', icon: 'book-open' },
    ],
    uniforms: {
      boys: { image: null, label: "Official St. Mary's Uniform" },
      girls: { image: null, label: "Official St. Mary's Uniform" },
    },
    achievements: ['Renowned for strong discipline and value-based education'],
    admissions: {
      date: 'Admissions Open 2026-27',
      status: 'Open',
    ...
    auditNotes: ['Christian minority institution serving the Greater Noida West area.'],
    classification: 'nearby_surrounding',
